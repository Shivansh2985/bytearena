...
const skills = [
  { name: 'C++', level: 92 }, { name: 'Python', level: 78 },
  { name: 'Dynamic Programming', level: 75 }, { name: 'Graph Theory', level: 88 },
  { name: 'Data Structures', level: 90 }, { name: 'System Design', level: 65 },
  { name: 'Java', level: 60 }, { name: 'SQL', level: 72 },
];

const projects = [
  {
    id: 'p1', title: 'Distributed Task Scheduler',
    desc: 'A fault-tolerant distributed task scheduler built with Go and Redis. Handles 10k+ tasks/sec with sub-100ms latency.',
    tags: ['Go', 'Redis', 'Docker', 'gRPC'],
    stars: 234, link: '#',
  },
  {
    id: 'p2', title: 'Competitive Programming Tracker',
    desc: 'Full-stack app to track CP progress across Codeforces, LeetCode, and AtCoder with analytics dashboard.',
    tags: ['Next.js', 'TypeScript', 'PostgreSQL'],
    stars: 187, link: '#',
  },
  {
    id: 'p3', title: 'Graph Visualizer',
    desc: 'Interactive graph algorithm visualizer supporting BFS, DFS, Dijkstra, and MST with step-by-step animation.',
    tags: ['React', 'D3.js', 'Canvas API'],
    stars: 312, link: '#',
  },
];

const experience = [
  { id: 'e1', role: 'SDE Intern', company: 'Google', period: 'May–Aug 2025', desc: 'Worked on distributed systems for Google Cloud Storage.' },
  { id: 'e2', role: 'Research Intern', company: 'IIT Bombay', period: 'Dec–Jan 2025', desc: 'Researched graph algorithms for social network analysis.' },
];

const stats = [
  { label: 'Problems Solved', value: '1,047' },
  { label: 'Contest Rating', value: '2,341' },
  { label: 'Global Rank', value: '#342' },
  { label: 'Contests', value: '94' },
];
      ...
      <div className="px-6 lg:px-8 xl:px-10 py-6 max-w-screen-xl mx-auto space-y-6">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">@rahul.kumar · Expert · IIT Delhi, CSE 2026</p>
                </div>
              ...
              <p className="text-sm text-foreground/80 mt-3 leading-relaxed max-w-2xl">
                Competitive programmer & full-stack developer. Passionate about algorithms, distributed systems, and building tools that help developers grow. 3× ICPC Regionalist.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-4 mt-3">
                ...
                <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                  <Link2 size={12} />
                  <span className="text-sky-400 hover:underline cursor-pointer">rahulkumar.dev</span>
                </div>
                <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                  <GithubIcon size={12} />
                  <span className="hover:text-foreground cursor-pointer">github.com/rahulkumar</span>
                </div>
                <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                  <TwitterIcon size={12} />
                  <span className="hover:text-foreground cursor-pointer">@rahulkumar_cp</span>
                </div>
              </div>
            </div>
          </div>
        ...
        {activeTab === 'overview' && (
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            ...
            <div className="bg-card-elevated border border-border rounded-xl p-5">
              ...
              <div className="space-y-3">
                {[
                  { icon: '🏆', title: '3× ICPC Regionalist', sub: '2023, 2024, 2025' },
                  { icon: '⭐', title: 'Expert on Codeforces', sub: 'Rating: 1847' },
                  { icon: '🥇', title: 'Google Kickstart Round A', sub: 'Rank 234 globally' },
                  { icon: '🎯', title: 'LeetCode Guardian', sub: '2400+ rating' },
                  { icon: '🔥', title: '31-day Streak', sub: 'ByteArena record' },
                ].map((a, i) => (
        ...
        {activeTab === 'projects' && (
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">
            {projects.map((p) => (
              <div key={p.id} className="bg-card-elevated border border-border rounded-xl p-5 hover:border-sky-500/30 transition-colors group">
        ...
        {activeTab === 'experience' && (
          <div className="space-y-4">
            {experience.map((e) => (
              <div key={e.id} className="bg-card-elevated border border-border rounded-xl p-5 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-sky-400 font-medium">{e.company} · {e.period}</p>
